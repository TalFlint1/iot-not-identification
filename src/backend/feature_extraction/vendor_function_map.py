vendor_function_map = {
    ...
    # "samsung": ['Smart TV', 'Smart Refrigerator', 'Smart Washing Machine', 'Hub', 'Smartwatch', ' Smart Speaker', 'Smart Plug', 
    #             'Smart Bulb', 'Smart Lock', 'Smart Sensor', 'Smart Thermostat', 'Smart Camera'],
