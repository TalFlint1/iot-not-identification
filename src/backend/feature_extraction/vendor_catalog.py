vendors = ['honeywell', 'huawei', 'bosch', 'cisco' ,'samsung', 'digi', 'rockwell automation',
           'nvidia', 'qualcomm', 'infineon', 'relayr', 'google', 'eaton', 'omron industrial automation',
           'nokia', 'telit', 'dji enterprise', 'impinj', 'johnson controls', 'panasonic', 'toshiba', 'tesla', 
